  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="mx-auto w-full pb-12 pt-0 md:pt-12">
        ...
        <div
          id="emails"
          className="w-full space-y-8 bg-gradient-to-br from-primary to-primary/80 px-4 py-10 dark:to-primary/50 sm:py-20 md:py-36"
        >
          <div className="mb-12 flex flex-col gap-4 px-2 md:items-center">
            ...
            <p className="max-w-sm text-pretty text-left text-xl md:max-w-xl md:text-center md:text-2xl">
              Craft beautiful emails with our drag and drop editor.
            </p>
          </div>
          <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-8 md:grid-cols-2">
            <div className="flex h-full flex-col justify-between gap-6 rounded-xl border bg-gradient-to-br from-card/90 to-background/90 p-8">
            ...
            <div className="flex h-full flex-col justify-between gap-4 rounded-xl border bg-gradient-to-br from-card/90 to-background/90 p-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Drag in the blocks you need to create the perfect emails for
                  your church.
                </p>
              </div>
            </div>
