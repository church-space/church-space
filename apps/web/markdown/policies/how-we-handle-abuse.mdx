...
We build our products to give ministries a better way to work and connect with their people. We are proud of that purpose and trust that our customers use our products for appropriate endeavors.

Sometimes, though, we discover potential abusive usage as detailed in our [Use Restrictions policy](https://churchspace.co/policies/use-restrictions). When that happens, we investigate using the following guiding principles and process.

## **Guiding Principles**

**Human oversight**
Real humans from the Church Space team will oversee any abuse case. On rare occasions for particularly sensitive situations or if legally required, we may also seek counsel from external experts.
...
- Someone alerts us. We give [abuse reports](https://churchspace.co/policies/use-restrictions) our full care and attention. Our Support team also responds to every question or comment that comes in. If we notice anything in those emails that points to a violation, we will look into it.
...
- We stumble upon public web content that links an individual or organization to a Church Space product. We aren’t scouring the Internet looking for those links, but if we do come across any, we check them out.
...
For other cases, we will consider good faith appeals sent to [appeals@churchspace.co](mailto:appeals@churchspace.co) by the account owner within 14 calendar days.
